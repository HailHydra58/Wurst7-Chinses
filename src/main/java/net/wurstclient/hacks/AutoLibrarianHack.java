...
public final class AutoLibrarianHack extends Hack
    ...
    private final BookOffersSetting wantedBooks = new BookOffersSetting(
            "想要的书籍",
            "你想让村民出售的附魔书的列表。\n\n"
                    + "AutoLibrarian 将在学会出售这些书籍之一后停止训练当前的村民。\n\n"
                    + "你还可以为每本书设置最高价格，以防你已经有一个出售该书的村民，但你想以更便宜的价格购买。",
    ...
    private final CheckboxSetting lockInTrade = new CheckboxSetting(
            "锁定交易",
            "一旦村民学会出售你想要的书籍，就自动从村民那里购买东西。这可以防止村民以后更改交易。\n\n"
                    + "在使用此功能时，请确保你的库存中至少有 24 张纸和 9 个绿宝石。或者，1 本书和 64 个绿宝石也可以。",
            false);
