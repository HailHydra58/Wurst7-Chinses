...
public final class ModelSettings {
    public final EnumSetting<OpenAiModel> openAiModel = new EnumSetting<>(
            "OpenAI model",
            "用于OpenAI API调用的模型。\n\n"
                    + "\u00a7lText-Davinci-003\u00a7r（也称为GPT-3）是一个较旧的模型，比ChatGPT的审查要少，但使用它的成本也高出10倍。\n\n"
                    + "\u00a7lGPT-3.5-Turbo\u00a7r（也称为ChatGPT）是大多数用例的推荐模型，因为它相对便宜且功能强大。\n\n"
                    + "\u00a7lGPT-4\u00a7r更强大，但只有在OpenAI选择您成为测试人员时才能使用。它的价格可能比ChatGPT高出15倍到60倍不等。",
